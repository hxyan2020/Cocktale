...
export const nl: Messages = {
  ...
  nav: { discover: "Ontdekken", catalogue: "Catalogus", journey: "Reis", book: "Boek", journal: "Dagboek", signOut: "Uitloggen", hub: "My Hub", preferences: "Preference", measure: "Measure", currency: "Currency", account: "Account" },
  login: {
...
export const pl: Messages = {
  ...
  nav: { discover: "Odkrywaj", catalogue: "Katalog", journey: "Podróż", book: "Książka", journal: "Dziennik", signOut: "Wyloguj", hub: "My Hub", preferences: "Preference", measure: "Measure", currency: "Currency", account: "Account" },
  login: {
...
export const bn: Messages = {
  ...
  nav: { discover: "আবিষ্কার", catalogue: "তালিকা", journey: "যাত্রা", book: "বই", journal: "জার্নাল", signOut: "সাইন আউট", hub: "My Hub", preferences: "Preference", measure: "Measure", currency: "Currency", account: "Account" },
  login: {
